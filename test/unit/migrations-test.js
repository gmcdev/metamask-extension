...
const migration2 = require(path.join('..', '..', 'metamask-controller', 'src', 'migrations', '002'))
const migration3 = require(path.join('..', '..', 'metamask-controller', 'src', 'migrations', '003'))
const migration4 = require(path.join('..', '..', 'metamask-controller', 'src', 'migrations', '004'))
const migration5 = require(path.join('..', '..', 'metamask-controller', 'src', 'migrations', '005'))
const migration6 = require(path.join('..', '..', 'metamask-controller', 'src', 'migrations', '006'))
const migration7 = require(path.join('..', '..', 'metamask-controller', 'src', 'migrations', '007'))
const migration8 = require(path.join('..', '..', 'metamask-controller', 'src', 'migrations', '008'))
const migration9 = require(path.join('..', '..', 'metamask-controller', 'src', 'migrations', '009'))
const migration10 = require(path.join('..', '..', 'metamask-controller', 'src', 'migrations', '010'))
const migration11 = require(path.join('..', '..', 'metamask-controller', 'src', 'migrations', '011'))
const migration12 = require(path.join('..', '..', 'metamask-controller', 'src', 'migrations', '012'))
const migration13 = require(path.join('..', '..', 'metamask-controller', 'src', 'migrations', '013'))
